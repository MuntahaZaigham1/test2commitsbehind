...
import { IT2, T2Service, T2DetailsComponent, T2ListComponent,
	T2NewComponent } from '../';

describe('T2ListComponent', () => {
  let fixture:ComponentFixture<T2ListComponent>;
  let component:T2ListComponent;
  let el: HTMLElement;
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent(T2ListComponent);
  ...
  describe('Integration tests', () => {
      ...
      TestBed.configureTestingModule({
        ...
        imports: [
          ...
          RouterTestingModule.withRoutes([
            { path: 't2', component: T2ListComponent },
            { path: 't2/:id', component: T2DetailsComponent }
          ])
        ],
        providers: [
          T2Service,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(decodeURIComponent(location.path())).toBe(`/t2/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
